...
from application.use_cases.users import ListUsersUseCase, GetUserUseCase, CreateUserUseCase, UpdateUserUseCase, DeleteUserUseCase
...
list_tournaments_uc = ListTournamentsUseCase(container.tournament_repo)
get_tournament_uc = GetTournamentUseCase(container.tournament_repo)
